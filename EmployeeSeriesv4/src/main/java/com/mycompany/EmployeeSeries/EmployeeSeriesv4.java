...
public class EmployeeSeriesv4 {
    ...
    public static void main(String[] args) {
        HourlyEmployee test1 = new HourlyEmployee(1000, 400, new EmpName("Stephanie","Recla","E."),new Date(8,5,2004), new Date(2024,9,15), 1001);
        PieceWorkerEmployee test2 = new PieceWorkerEmployee(50000, 50, new EmpName("John Lorenz","Codilla","B"),new Date(5,20,2004), new Date(2024,9,15), 1002);
        ...
        BasePlusCommissionEmployee test4 = new BasePlusCommissionEmployee(15000.00, 2000, new EmpName("Crazy","Person","Buang"),new Date(3,5,2004), new Date(2024,9,15), 1004);
//        test1.display();
//        test2.display();
//        test3.display();
//        test4.display();
